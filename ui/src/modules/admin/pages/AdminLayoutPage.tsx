...
import {BuildingsList} from 'src/Modules/admin/pages/buildings/BuildingsList';
import {BuildingEdit} from 'src/Modules/admin/pages/buildings/BuildingEdit';
import {RoomsList} from 'src/Modules/admin/pages/rooms/RoomsList';
import {RoomEdit} from 'src/Modules/admin/pages/rooms/RoomEdit';
import {UsersList} from 'src/Modules/admin/pages/users/UsersList';
import {UserEdit} from 'src/Modules/admin/pages/users/UserEdit';
import {AdminMainPage} from 'src/Modules/admin/pages/AdminMainPage';

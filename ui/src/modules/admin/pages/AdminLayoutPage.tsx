...
const menuConfig = [
    ...
    },
    {
        ...
        title: () => (
            <div>
                <ScheduleOutlined /> {i18n.t('Admin:menu.events.title')}
            </div>
        ),
        items: [
            {
                ...
                <Row gutter={{xs: 8, sm: 16, md: 24}}>
                    ...
                    <Col span={20} className="border-right">
                        <Switch>
                            ...
                            <RouteWrap
                                role={ERoles.ADMIN}
                                path={ROUTER.MAIN.ADMIN.EVENTS.EDIT.FULL_PATH}
                            >
                                <AdminMainPage />
                            </RouteWrap>
                            <RouteWrap
                                role={ERoles.ADMIN}
                                path={ROUTER.MAIN.ADMIN.EVENTS.FULL_PATH}
                            >
                                <AdminMainPage />
                            </RouteWrap>
